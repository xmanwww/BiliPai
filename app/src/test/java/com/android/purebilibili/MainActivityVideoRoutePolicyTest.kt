...
class MainActivityVideoRoutePolicyTest {
    ...
    fun notificationRoute_defaultsToAutoPortraitAndStartAudioFalse() {
        assertEquals(
            "video/BV1abc?cid=0&cover=&startAudio=false&autoPortrait=true&resumePositionMs=0",
    ...
    fun notificationRoute_keepsCidValue() {
        assertEquals(
            "video/BV2xyz?cid=12345&cover=&startAudio=false&autoPortrait=true&resumePositionMs=0",
